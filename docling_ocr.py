#!/usr/bin/env python3
# OCR forcé d'un document (PDF scanné, etc.) via le service Docling, sur GPU.
...
# les pages-images sur la RTX (EasyOCR/RapidOCR CUDA) et renvoyer le texte.
#
...
def _multipart(fields, files):
    """Construit un corps multipart/form-data. fields = dict, files = [(name, path)]."""
...
def ocr_document(path, force=True):
    ...
    fields = {
        ...
        "ocr_engine": os.environ.get("DOCLING_PIPELINE_OCR_ENGINE", "easyocr"),
